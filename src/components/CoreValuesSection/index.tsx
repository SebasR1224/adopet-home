    ...
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
      <div className="container">
        <SectionTitle
          ...
          paragraph="Descubre los principios y objetivos que guían nuestras acciones en Adopet. Estamos comprometidos con la protección y el bienestar de los animales abandonados, trabajando cada día para crear un mundo mejor para ellos."
          width="640px"
          center
        />
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <CoreValueItem
              ...
              description="Nuestra misión es conectar a la comunidad con las fundaciones de rescate animal para reducir el abandono de animales en las calles. A través de la tecnología, facilitamos el reporte y la gestión de rescates, asegurando que cada animal encuentre el cuidado y el hogar que merece."
              icon={MissionIcon}
            />
          </div>
          ...
          <div className="w-full px-4 lg:w-1/2">
            <CoreValueItem
              ...
              description="Nuestra visión es crear un mundo donde no haya animales abandonados y donde cada mascota tenga un hogar seguro y amoroso. Aspiramos a ser la plataforma líder en el rescate y adopción de animales, promoviendo la concienciación y el compromiso comunitario."
              icon={VisionIcon}
            />
          </div>
        </div>
