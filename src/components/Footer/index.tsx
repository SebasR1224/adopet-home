        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-8 max-w-[270px] text-base text-gray-7">
                Transformamos ideas en soluciones digitales innovadoras para
                ayudarte a alcanzar el éxito en un mundo cada vez más conectado.
              </p>
              <div className="-mx-3 flex items-center">
                ...
                >
                  ...
                  >
                    ...
                    <path d="M14.7554 1.8335H7.24463C4.25807 1.8335 1.83334 4.25823 1.83334 7.24479V14.6964C1.83334 17.7421 4.25807 20.1668 7.24463 20.1668H14.6962C17.7419 20.1668 20.1667 17.7421 20.1667 14.7555V7.24479C20.1667 4.25823 17.7419 1.8335 14.7554 1.8335ZM11.0296 15.4948C8.51614 15.4948 6.53496 13.4545 6.53496 11.0002C6.53496 8.54586 8.54571 6.50554 11.0296 6.50554C13.4839 6.50554 15.4946 8.54586 15.4946 11.0002C15.4946 13.4545 13.5134 15.4948 11.0296 15.4948ZM17.2393 6.91952C16.9436 7.24479 16.5 7.30748 16.1019 7.02952C14.8072 6.09291 13.3284 6.02861 12.2197 6.83431C11.9253 7.0795 11.6021 7.17442 11.2844 7.28398C11.132 7.36759 11.0143 7.53804 10.9745 7.71754C10.9229 8.01577 11.0911 8.30457 11.3443 8.35397C13.4914 8.52665 15.2768 10.1902 15.5387 12.3445C15.6122 12.6927 15.8957 12.9671 16.1977 13.04C16.4906 13.1102 16.8147 12.9497 17.0704 12.7136C17.3577 12.4321 17.3411 11.9102 17.0704 11.5232C16.6177 10.7648 16.0587 10.0982 15.4034 9.50798C16.1223 9.47686 16.8378 9.39547 17.4623 8.98999C17.7518 8.67932 17.7808 8.23665 17.4602 7.94713C17.2563 7.76834 16.9356 7.74755 16.6612 7.91213C15.8396 8.29593 14.8749 8.53983 13.8635 8.58899C14.1414 8.23072 14.3027 7.74131 14.3878 7.26797C14.5887 6.63164 15.0572 6.14816 15.5481 6.05014C16.0013 5.97776 16.4181 6.23448 17.2393 6.91952Z" />
                  </svg>
                </Link>
              </div>
            </div>
            ...
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <Link
                    href="/#"
                    className="mb-3 block text-base text-gray-7 hover:text-white"
                  >
                    Inicio
                  </Link>
                </li>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10">
              ...
              <ul>
                <li>
                  <p className="mb-3 text-base text-gray-7">
                    Cr 122 #01 - 2 City
                  </p>
                </li>
                <li>
                  <p className="mb-3 text-base text-gray-7">+57 1234567</p>
                </li>
                <li>
                  <p className="text-base text-gray-7">info@adopet.com</p>
                </li>
              </ul>
            </div>
          </div>
